...
from models.treatment.gprpp.kernel import get_hyperparameters, get_mark_output, get_mark_lengthscales
from models.treatment.gprpp.utils.Gtilde import tf_Gtilde_lookup
from models.treatment.gprpp.utils.phivector import tf_calc_Phi_SqExp_vec
from models.treatment.gprpp.utils.psimatrix import tf_calc_Psi_matrix_vec
from models.treatment.gprpp.utils.tf_utils import tf_vec_mat_vec_mul, tf_vec_dot
...
class GPRegressiveMarkedPP(gpflow.models.GPModel, gpflow.models.ExternalDataTrainingLossMixin):
    def __init__(
        self,
        ...
        *,
        ...
        """
        Implementation of the GP regressive marked point process model.

        D = number of dimensions: U (#types) x Q_u (#last events)
        ...
        :param kernel: the kernel (here only implemented for a gpflow.kernels.SquaredExponential instance)
        ...
        :param time_dims: specifies the time dimensions for the time-kernel input
        :param mark_dims: specifies the mark dimensions for the mark-kernel input
        :param marked: if the model has marked input
